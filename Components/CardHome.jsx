    ...
    return (
        <div className="card-compact w-full bg-base-100">
            ...
            <div className="">
                ...
                <h2 className="card-title font-bold">Mereum sanctuary</h2>
                ...
                <div className="card-actions mt-10">
                    <button className="btn bg-stay-secondary border-none text-white w-[168px]">Book Now</button>
                    <button className="btn btn-link text-stay-seondary w-[168px]">View Detail</button>
                </div>
            </div>
        </div>
    )
