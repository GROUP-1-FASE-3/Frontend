...
const CardHome = ({villa_name, address, price, imgUrl}) => {
    return (
        <div className="card-compact shadow bg-white rounded-xl">
            ...
            <div className="card-body self-end">
                ...
                <p className='text-stay-grey flex'><svg className='mr-2 ' width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 -9.15527e-05C3.13 -9.15527e-05 0 3.12991 0 6.99991C0 12.2499 7 19.9999 7 19.9999C7 19.9999 14 12.2499 14 6.99991C14 3.12991 10.87 -9.15527e-05 7 -9.15527e-05ZM7 9.49991C5.62 9.49991 4.5 8.37991 4.5 6.99991C4.5 5.61991 5.62 4.49991 7 4.49991C8.38 4.49991 9.5 5.61991 9.5 6.99991C9.5 8.37991 8.38 9.49991 7 9.49991Z" fill="#848484" />
                </svg>
                    {address}</p>
                <div className="card-actions mt-10 justify-center">
                    <button className="btn bg-stay-secondary border-none text-white lg:w-[45%] md:w-full md:text-xs">Book Now</button>
                    <button className="btn bg-transparent hover:bg-transparent border-none text-stay-secondary lg:w-1/2 md:w-full md:text-xs">View Detail</button>
                </div>
            </div>
        </div>
    )
