...
const CardHome = ({villa_name, address, price}) => {
    return (
        <div className="card-compact w-full bg-base-100">
            ...
            <div className="">
                ...
                <h2 className="card-title font-bold">{villa_name}</h2>
                ...
                <div className="card-actions mt-10">
                    <button className="btn bg-stay-secondary border-none text-white w-1/2">Book Now</button>
                    <button className="btn btn-link text-stay-secondary w-2/5">View Detail</button>
                </div>
            </div>
        </div>
    )
